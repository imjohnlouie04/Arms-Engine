...
- Mobile-First Mandate: on mobile and Mobile Extended layouts, raise interactive controls to h-11 min for touch targets while preserving normal desktop density.
- Never render dense <Table> on mobile; keep table layouts in 'hidden md:block' and provide stacked <Card> layouts for 'block md:hidden'.
