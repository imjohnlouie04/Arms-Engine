...
3.  **Log State:** Save this changelog to `./.arms/reports/release-notes-latest.md` in the local project directory. When the latest release notes change, archive the prior revision into `./.arms/reports/REPORT_HISTORY.md`.
