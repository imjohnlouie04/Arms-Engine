...
> **Quick reference:** All available skills for supported CLIs
...
**File:** `.claude/commands/3d-web-experience/SKILL.md`
...
**File:** `.claude/commands/accessibility-auditor/SKILL.md`

**Source Directory:** `arms_engine/skills/accessibility-auditor`

### `arms-docs-generator/SKILL.md`
**arms-docs-generator**

Technical Documentation & Architecture Visualization Specialist

**File:** `.claude/commands/arms-docs-generator/SKILL.md`

### `arms-orchestrator/SKILL.md`
**arms-orchestrator**

Full-stack project orchestration system for Next.js, Nuxt, or Astro projects with Supabase, Firebase, or custom backends. Manages multi-agent workflows with explicit approval gates at every critical decision. Activate this skill when the user types 'init', 'start', 'doctor', 'task log', 'task update', 'task done', 'release check', 'run review', 'fix issues', 'run deploy', 'run status', or 'run pipeline'; when managing session state, memory, and task delegation; when enforcing standards across frontend, backend, DevOps, security, SEO, and QA; when building SaaS, content/marketing, or mobile-first apps with coordinated subagents; or when the user mentions agents, orchestration, tech stack selection, or MVP planning. Also activate for ANY request that creates durable work: feature requests, bug fixes, audits, code reviews, refactors, improvements, or any message containing 'fix', 'add', 'build', 'audit', 'improve', 'implement', 'review', 'update', or 'create' directed at project code or features. Use for any coordinated full-stack development requiring specialized subagents. IMPORTANT: For all such requests, log the task with 'arms task log' before executing.

**File:** `.claude/commands/arms-orchestrator/SKILL.md`

### `backend-system-architect/SKILL.md`
**backend-system-architect**

Design and architect scalable, reliable backend systems. Use this for system architecture decisions, backend design patterns, microservices vs monolith tradeoffs, API design, database architecture, distributed systems design, scalability planning, performance optimization, infrastructure design, service decomposition, data consistency patterns, event-driven architectures, API gateways, load balancing strategies, caching strategies, observability and monitoring design, fault tolerance patterns, cloud architecture, deployment patterns, or any backend architectural planning and decision-making.

**File:** `.claude/commands/backend-system-architect/SKILL.md`

### `caveman-compressor/SKILL.md`
**caveman-compressor**

Context Efficiency Specialist

**File:** `.claude/commands/caveman-compressor/SKILL.md`
...
**File:** `.claude/commands/devops-orchestrator/SKILL.md`
...
**File:** `.claude/commands/frontend-design/SKILL.md`

### `logo-design/SKILL.md`
**logo-design**

Gather client requirements and generate a beautiful, professional HD logo using Gemini image generation as the PRIMARY output method. Trigger this skill whenever a user asks for a logo, brand mark, wordmark, icon, or visual identity — even casual phrasing like "make me a logo", "design something for my business", "I need a brand icon", "create a logo for my app", or "I want a clever logo with hidden meaning". Always use this skill before generating any logo output. Output is always a HD 4K PNG via Gemini — no SVG hand-coding. The Gemini prompt IS the design.

**File:** `.claude/commands/logo-designer/SKILL.md`

**Source Directory:** `arms_engine/skills/logo-designer`
...
**File:** `.claude/commands/nano-banana-pro/SKILL.md`
...
**File:** `.claude/commands/pse-trading/SKILL.md`

### `qa-automation-testing/SKILL.md`
**qa-automation-testing**

Write robust, maintainable unit and E2E tests using Jest, Cypress, and Playwright. Use this for any testing task including writing new tests, debugging flaky tests, refactoring test suites, setting up test infrastructure, choosing testing strategies, creating fixtures and mocks, improving test performance, or reviewing test code. Also applies when working with test files, CI/CD test pipelines, test coverage, or when the user mentions testing, QA, quality assurance, pre-flight validation, test automation, Jest, Cypress, Playwright, test-driven development (TDD), or asks to add tests.

**File:** `.claude/commands/qa-automation-testing/SKILL.md`
...
**File:** `.claude/commands/security-code-review/SKILL.md`

### `seo-web-performance-expert/SKILL.md`
...
**File:** `.claude/commands/seo-web-performance-expert/SKILL.md`
...
**File:** `.claude/commands/ui-ux-pro-max/SKILL.md`

## Usage

Reference a skill from the local skill mirror:

```
.claude/commands/arms-orchestrator/SKILL.md
