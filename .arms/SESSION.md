...
- [Developer Preferences] Capture the preferred orchestration pattern that emerged while implementing 'Fix Codex delegation wait loop repeatedly reporting no agents completed and ensure delegated' so future deep-dive work follows the same path. (confidence: 0.97)
